...
public class ThaiCuisine extends JFrame{
	...
	private double a1Price = 12.99;
	private double a2Price = 9.99;
	private double a3Price = 10.95;
	private double e1Price = 12.00;
	private double e2Price = 14.99;
	private double e3Price = 12.99;
	private double e4Price = 16.00;
	private double d1Price = 6.00;
	private double d2Price = 4.95;
	private double w1Price = 20.00;
	private double w2Price = 27.00;
	private double w3Price = 33.00;
	private double s1Price = 4.99;
	private double s2Price = 6.99;
					
	
	public ThaiCuisine() {
		
		// Set up size, title and background for our menu window
		setTitle("Happy Thai Restaurant");
		setSize(700, 700);
		getContentPane().setLayout(null);
		
		ImageIcon img = new ImageIcon("thaiRestaurant.jpg");
		...
		area1 = new JTextArea();
		area1.setBounds(399, 105, 301, 406);
		area1.setBorder(blackline);
		area1.setText("  Welcome to Happy Thai Restaurant!\n  What are on your mind today?\n (Please "
		...
		panel.setBounds(18, 143, 379, 303);
		...
		// First appetizer
		JCheckBox a1 = new JCheckBox("Thai Coconut Shrimp (12.99)");
		...
		// Second appetizer
		JCheckBox a2 = new JCheckBox("Peanut Salad Wonton (9.99)");
		...
		// Third appetizer
		JCheckBox a3 = new JCheckBox("Thai Pinwheels (10.95)");
		...
		// First entree
		JCheckBox e1 = new JCheckBox("Thai Red Curry (12.00)");
		...
		// Second entree
		JCheckBox e2 = new JCheckBox("Pineapple Fried Rice (14.99)");
		...
		// Third entree
		JCheckBox e3 = new JCheckBox("Chicken Pad Thai (12.99)");
		...
		// Fourth entree
		JCheckBox e4 = new JCheckBox("Asparagus and Shrimp (16.00)");
		...
		// First dessert
		JCheckBox d1 = new JCheckBox("Mango Sticky Rice (6.00)");
		...
		// Second dessert
		JCheckBox d2 = new JCheckBox("Fried Banana (4.95)");
		...
		panel_1.setBounds(19, 458, 379, 128);
		...
		// First wine
		JCheckBox w1 = new JCheckBox("Vodka (20.00)");
		...
		w1q.setColumns(10);
		w1q.setBounds(302, 2, 49, 26);
		panel_1.add(w1q);
		
		
		// Second wine
		JCheckBox w2 = new JCheckBox("Tequila (27.00)");
		...
		w2q.setColumns(10);
		w2q.setBounds(302, 20, 49, 26);
		panel_1.add(w2q);
		
		
		// Third wine
		JCheckBox w3 = new JCheckBox("Whisky (33.00)");
		...
		// First Soft Drink
		JCheckBox s1 = new JCheckBox("Coke (4.99)");
		...
		s1q.setColumns(10);
		s1q.setBounds(302, 82, 49, 26);
		panel_1.add(s1q);
		
		
		// Second Soft Drink
		JCheckBox s2 = new JCheckBox("Fanta (6.99)");
		...
		panel_2.setBounds(19, 598, 379, 49);
			...
			public void actionPerformed(ActionEvent e) {
				if (!(r1.isSelected() || r2.isSelected()) || 
					...
					new Warning1();
						...
						(e1.isSelected() && e1q.getText().equals("")) || 
