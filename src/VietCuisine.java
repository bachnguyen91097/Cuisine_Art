...
public class VietCuisine extends JFrame{
	...
	private double a1Price = 6.99;
	private double a2Price = 5.99;
	private double a3Price = 2.99;
	private double e1Price = 11.99;
	private double e2Price = 8.99;
	private double e3Price = 9.99;
	private double e4Price = 8.00;
	private double d1Price = 5.99;
	private double d2Price = 7.95;
	private double w1Price = 14.00;
	private double w2Price = 20.00;
	private double w3Price = 40.00;
	private double s1Price = 5.99;
	...
	public VietCuisine() {
		...
		setTitle("Majestic Vietnamese Restaurant");
		setSize(700, 700);
		getContentPane().setLayout(null);
		
		ImageIcon img = new ImageIcon("vietRestaurant.jpeg");
		...
		area1.setText("  Welcome to Majestic Vietnamese Restaurant!\n  What are on your mind today?\n (Please "
		...
		// First appetizer
		JCheckBox a1 = new JCheckBox("Summer Rolls (6.99)");
		...
		// Second appetizer
		JCheckBox a2 = new JCheckBox("Beef Jerky Salad (5.99)");
		...
		// Third appetizer
		JCheckBox a3 = new JCheckBox("Roasted Peanut (2.99)");
		...
		// First entree
		JCheckBox e1_1 = new JCheckBox("Bun Cha (11.99)");
		...
		// Second entree
		JCheckBox e2 = new JCheckBox("Grilled Pork Rice (8.99)");
		...
		// Third entree
		JCheckBox e3 = new JCheckBox("Beef Pho (9.99)");
		...
		// Fourth entree
		JCheckBox e4 = new JCheckBox("Chicken Noodle Soup (8.00)");
		...
		// First dessert
		JCheckBox d1 = new JCheckBox("3 Color Dessert (5.99)");
		...
		// Second dessert
		JCheckBox d2 = new JCheckBox("Sliced Fruit (7.95)");
		...
		// First wine
		JCheckBox w1 = new JCheckBox("Plum Wine (14.00)");
		...
		// Second wine
		JCheckBox w2 = new JCheckBox("Rice Spirit (20.00)");
		...
		// Third wine
		JCheckBox w3 = new JCheckBox("Vang Da Lat (40.00)");
		...
		// First Soft Drink
		JCheckBox s1 = new JCheckBox("Bubble Tea (5.99)");
